...
Det finns i dagsläget utvecklade tekniker som är genomförbara och möjliga att implementera för att ge användare möjlighet att få insyn över den datahantering som sker i stängda system. Tekniken som presenteras av Pulls et. al. \cite{Pulls} grundar sig i statliga myndigheter och känslig data, såsom läkarjournaler, med det finns ingen avgränsning eller indikation i artikeln att lösningarna inte är applicerbara även inom andra områden. 
