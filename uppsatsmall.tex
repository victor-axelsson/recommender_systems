...
\begin{tabular}{l p{12cm} }
	API & Gränssnitt mellan programmoduler kallas ofta API (engelskaapplication programming interface). Likt fallet med hårdvara vill man kunna använda programkomponenter från olika tillverkare, det vill säga utnyttja olika implementationer av ett visst gränssnitt \cite{GUI}. \\ \\
	
	HTTP & hypertext transfer protocol, kommunikationsprotokoll som används på World Wide Web för överföring av bl.a. HTML-dokument och bildfiler \cite{HTTP}. \\\\
	
	Open Source & öppen källkod, princip för datorprogram där användaren har fri tillgång till programmets källkod och därför kan förstå, korrigera och modifiera programmet \cite{OpenSource}. \\\\
	
	PHP & Ursprungligen förkortning för Personal Home Pages, senare PHP Hypertext Preprocessor, skriptspråk för hantering av webbsidor, skapat 1995 av grönländaren Rasmus Lerdorf (född 1968) \cite{PHP}. \\\\
	
	Proxy & Proxyserver, mellanserver, proxy, server som skickar vidare ett anrop från en klient och därefter skickar ett svar tillbaka till klienten \cite{ProxyServer}. \\\\
	
	Relationsdatabas &  Databas i vilken data representeras i form av tabeller \cite{RelationsDatabas}. \\\\
	
	Black box & Blackbox-metoden [blÃ¦k-], indirekt metod att kartlägga processer som inte kan studeras direkt. I t.ex. naturvetenskaplig forskning måste ibland ett komplext system betraktas som en ``svart låda'', en black box \cite{BlackBox}. \\\\
...
Användare kan begränsa rekommendationernas underlag genom att utnyttja problemet med kallstart. Det avhandlas tydligt i litteraturdelen av detta dokument som ett genomgående problem för rekommendationer med att ha tillgång till lite information. Mekanismer för att utnyttja detta till användarens fördel kommer inte avhandlas vidare.
...
\bibitem{BlackBox}Nationalencyklopedin. blackbox-metoden. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/blackbox-metoden}
...
\bibitem{GUI}Nationalencyklopedin. gränssnitt. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/gränssnitt}

\bibitem{HTTP}Nationalencyklopedin. HTTP. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/http}


\bibitem{PHP}Nationalencyklopedin. PHP. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/php}

\bibitem{ProxyServer}Nationalencyklopedin. proxyserver. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/proxyserver}

\bibitem{RelationsDatabas}Nationalencyklopedin. relationsdatabas. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/relationsdatabas}
...
\bibitem{OpenSource}Nationalencyklopedin. öppen källkod. [Internet] 2015 [citerad: 2015-09-27] Hämtad från: \url{http://www.ne.se/uppslagsverk/encyklopedi/lång/öppen-källkod}
